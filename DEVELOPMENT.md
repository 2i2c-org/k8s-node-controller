...
See the `scripts` in [pyproject.toml](https://github.com/2i2c-org/jupyterhub-node-warmer/blob/main/pyproject.toml) to see the configured commands available to `hatch run <env>:<command>`.
